...
export default function Profile() {
  ...
  const handleFileUpload = () => {
    ...
    const fileName = new Date().getTime() + file.name; // to get a unique file name
    ...
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-700">Error while uploading</span>
        ...
        <Link
          to=""
          className="bg-green-700 text-center text-white rounded-lg
          p-3 uppercase hover:opacity-95 disabled:opacity-80"
        >
          create listing
        </Link>
